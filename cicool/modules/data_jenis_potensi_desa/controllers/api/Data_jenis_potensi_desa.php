...
class Data_jenis_potensi_desa extends API
{
	...
	public function all_get()
	{
		...
		$data_jenis_potensi_desas = array_map(function($row){
						
			return $row;
		}, $data_jenis_potensi_desas);
	...
	public function detail_get()
	{
		...
		$select_field = ['id_jenis_potensi', 'nama_potensi'];
		$data_jenis_potensi_desa = $this->model_api_data_jenis_potensi_desa->find($id, $select_field);
		...
		$data['data_jenis_potensi_desa'] = $data_jenis_potensi_desa;
