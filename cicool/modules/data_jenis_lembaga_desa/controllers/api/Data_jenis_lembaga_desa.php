...
class Data_jenis_lembaga_desa extends API
{
	...
	public function all_get()
	{
		...
		$data_jenis_lembaga_desas = array_map(function($row){
						
			return $row;
		}, $data_jenis_lembaga_desas);
	...
	public function detail_get()
	{
		...
		$select_field = ['id_lembaga', 'nama_lembaga'];
		$data_jenis_lembaga_desa = $this->model_api_data_jenis_lembaga_desa->find($id, $select_field);
		...
		$data['data_jenis_lembaga_desa'] = $data_jenis_lembaga_desa;
