...
class Data_lembaga_desa extends API
{
	...
	public function all_get()
	{
		...
		$data_lembaga_desas = array_map(function($row){
	...
	public function detail_get()
	{
		...
		$select_field = ['id_lembaga', 'nama_lembaga', 'jenis_lembaga'];
		$data_lembaga_desa = $this->model_api_data_lembaga_desa->find($id, $select_field);
		...
		$data['data_lembaga_desa'] = $data_lembaga_desa;
