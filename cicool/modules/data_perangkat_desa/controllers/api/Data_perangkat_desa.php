...
class Data_perangkat_desa extends API
{
	...
	public function all_get()
	{
		...
		$data_perangkat_desas = array_map(function($row){
						
			return $row;
		}, $data_perangkat_desas);
	...
	public function detail_get()
	{
		...
		$select_field = ['id_perangkat_desa', 'nama_perangkat_desa', 'jabatan'];
		$data_perangkat_desa = $this->model_api_data_perangkat_desa->find($id, $select_field);
		...
		$data['data_perangkat_desa'] = $data_perangkat_desa;
