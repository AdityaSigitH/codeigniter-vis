...
class Data_surat_keluar extends API
{
	...
	public function all_get()
	{
		...
		$data_surat_keluars = array_map(function($row){
	...
	public function detail_get()
	{
		...
		$select_field = ['No_id_Surat', 'id_surat_keluar', 'tgl_keluar', 'Perihal'];
		$data_surat_keluar = $this->model_api_data_surat_keluar->find($id, $select_field);
		...
		$data['data_surat_keluar'] = $data_surat_keluar;
